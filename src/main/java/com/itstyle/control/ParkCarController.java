...
public class ParkCarController {
    ...
    @ResponseBody
    public Response uploadBill(String mcNo, String carNo, Long operTime, Integer fee, String openId, Long enterTime, CarType carType,ChargeSituation chargeSituation) {
        int status = parkCarService.uploadBill(mcNo, carNo, operTime, fee, openId, enterTime,carType, chargeSituation);
